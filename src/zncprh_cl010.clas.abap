...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'ZNCPRH_CL010' ##NO_TEXT.
  data ROOT type ref to ZNCPRH_CL009 read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to ZNCPRH_CL010
    raising
      CX_SHM_INCONSISTENT
...
CLASS ZNCPRH_CL010 IMPLEMENTATION.
