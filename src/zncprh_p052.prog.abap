...
* Target Recipent
  CLEAR reclist.
  reclist-receiver = 'necip.ertug@detaysoft.com'.
  reclist-rec_type = 'U'.
  APPEND reclist.
...
*--------------------------------------------------------------------*
*necip reha 22.10.2020 17:21:21 begin
*--------------------------------------------------------------------*
...
*--------------------------------------------------------------------*
*necip reha 22.10.2020 17:21:21 end
*--------------------------------------------------------------------*
...
* Sr. No.
    ...
    IF wa_final-srno EQ 3 OR wa_final-srno EQ 5.
      r_cell = l_document->create_simple_element( name = 'Cell'  parent = r_row ).
