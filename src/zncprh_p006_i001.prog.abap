...
DATA : BEGIN OF gs_ise_alim.
         INCLUDE STRUCTURE zncprh_s016.
       DATA: END OF gs_ise_alim,
       gt_ise_alim LIKE TABLE OF gs_ise_alim.

DATA: gt_ise_alim_excel TYPE TABLE OF zncprh_s016,
      gs_ise_alim_excel TYPE zncprh_s016.

DATA : BEGIN OF gs_isten_cikis.
         INCLUDE STRUCTURE zncprh_s017.
       DATA: END OF gs_isten_cikis,
       gt_isten_cikis LIKE TABLE OF gs_isten_cikis.

DATA: gt_isten_cikis_excel TYPE TABLE OF zncprh_s017,
      gs_isten_cikis_excel TYPE zncprh_s017.
